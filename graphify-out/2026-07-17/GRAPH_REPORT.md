...
## Corpus Check
- 182 files · ~266,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1573 nodes · 1724 edges · 199 communities (139 shown, 60 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `893d934e`
...
## Communities (199 total, 60 thin omitted)

### Community 0 - "Backend Bootstrap & Routing"
Cohesion: 0.06
Nodes (37): WIPE_TABLES, chunkedCreate(), gradeFor(), main(), rand(), chunked(), clamp(), GRID (+29 more)
...
Cohesion: 0.17
Nodes (11): Fly.io (CLI alternative), Frontend (Vercel), Production observability (Option A) — Grafana Cloud + Alloy, Railway (easiest, UI-driven), Step 1 — Protect and deploy the backend (Render), Step 2 — Create the Grafana Cloud stack (free), Step 3 — Deploy the Alloy agent (always-on host), Step 4 — Import the dashboard (+3 more)
...
Cohesion: 0.29
Nodes (6): Local and production monitoring, Production use, Start locally, Stop or reset local monitoring, Verify a performance change, What is collected

### Community 99 - "Community 99"
Cohesion: 0.25
Nodes (6): AuthUser, LoginResponse, LoginRole, RefreshResponse, University, UserRole

### Community 129 - "YearLevel"
Cohesion: 0.40
...
Cohesion: 0.48
Nodes (4): createApp(), env, envSchema, app
...
Cohesion: 0.22
Nodes (8): 10. Results — View Only, 13. Faculty Error Codes, Context & Scoping Rules, `GET /faculty/results`, `GET /faculty/results/leaderboard`, `GET /faculty/results/summary`, Table of Contents, UniPortal — Faculty API Reference
...
## Knowledge Gaps
- **854 isolated node(s):** `envSchema`, `Start locally`, `What is collected`, `Production use`, `Verify a performance change` (+849 more)
...
- **Why does `UniPortal — REST API Reference` connect `YearLevel` to `1. Auth & Session`, `2. Dashboard`, `12. Settings Page`, `9. Analytics Page`, `4. Faculty Page`, `3. Students Page`, `5. Results Page`, `6. Attendance Page`, `10. Promotion Page`, `8. Mentorship Page`, `11. Calendar Page`, `7. Subjects Page`?**
...
- **Why does `UniPortal — Faculty API Reference` connect `UniPortal — Faculty API Reference` to `5. Attendance — Mark & Track`, `1. Auth & Session`, `7. Quiz — Create & Manage`, `11. Calendar — View & Post`, `12. Analytics — Faculty View`, `4. Students — View Only`, `8. Announcements`, `2. Faculty Profile & Dashboard`, `10. Results — View Only`, `6. Notes — Upload & Manage`, `9. Mentorship — Mentee List & Chat`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `envSchema`, `Start locally`, `What is collected` to the rest of the system?**
