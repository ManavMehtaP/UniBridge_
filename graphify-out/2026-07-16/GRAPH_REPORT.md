# Graph Report - UniBridge_  (2026-07-16)

## Corpus Check
- 178 files · ~262,993 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1476 nodes · 1616 edges · 196 communities (135 shown, 61 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `560c9330`
...
1. `UniPortal — Scalable Multi-Role React Architecture` - 24 edges
2. `Store` - 24 edges
3. `12. Settings Page` - 22 edges
4. `compilerOptions` - 21 edges
5. `UniPortal — Student API Reference` - 19 edges
6. `UniPortal — REST API Reference` - 16 edges
7. `UniPortal — Faculty API Reference` - 16 edges
...
## Communities (196 total, 61 thin omitted)
...
## Knowledge Gaps
- **793 isolated node(s):** `Table of Contents`, ``POST /auth/login``, ``POST /auth/refresh``, ``POST /auth/logout``, ``POST /auth/forgot-password`` (+788 more)
...
- **Why does `UniPortal — REST API Reference` connect `UniPortal — REST API Reference` to `1. Auth & Session`, `2. Dashboard`, `12. Settings Page`, `9. Analytics Page`, `4. Faculty Page`, `3. Students Page`, `5. Results Page`, `6. Attendance Page`, `10. Promotion Page`, `8. Mentorship Page`, `11. Calendar Page`, `7. Subjects Page`?**
