...
// Paper-checking marks entry now lives in the unified block-based Examination
// module (examRouter: /exams/me/paper-checking, /exams/paper-checking/:id/marks).
// The old enrollment-range assignment endpoints were removed with that system.
